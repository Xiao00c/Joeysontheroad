...
function openModal() {
	...
	if (selectedOption) {
		...
		// console.log(index);
		fetch('https://apilearningapi.azurewebsites.net/api/questions/byFactor/speeding')
...
function loadNextQuestion(questionIndex) {
	...
	if (currentQuestion == totQuestions) {
		...
		Cookies.set('Speedy-completed', '1');
		Cookies.set('factor5score', score);
		Cookies.set('factor5scoreFull', total);
		return;
	}
